...
import link_selection

CONF = cfg.CONF


class MulticastRouting(app_manager.RyuApp):
    """
        ...
        network monitor and network delay detector modules.
    """
    ...
    def __init__(self, *args, **kwargs):
        super(MulticastRouting, self).__init__(*args, **kwargs)
    ...
    def arp_forwarding(self, msg, src_ip, dst_ip):
        """ Send ARP packet to the destination host,
            ...
            else, flow it to the unknown access port.
        """
        datapath = msg.datapath
        ofproto = datapath.ofproto
        parser = datapath.ofproto_parser
